...
import MenuItem1 from '../../Assets/PizzaMenu/1.jfif';
import MenuItem2 from '../../Assets/PizzaMenu/2.jfif';
import MenuItem3 from '../../Assets/PizzaMenu/3.jfif';
import MenuItem4 from '../../Assets/PizzaMenu/4.jfif';
import MenuItem5 from '../../Assets/PizzaMenu/5.jfif';
import MenuItem6 from '../../Assets/PizzaMenu/6.jfif';
...
export default function Order(props) {
	...
	const handleCart = (name, price, quantity) => {
		setCart([
			...cart,
			{ restaurant: 'Dominos Pizza', name, price, quantity, date: new Date().toLocaleString() }
		]);
	};
